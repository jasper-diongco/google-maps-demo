...
import 'package:google_maps_demo/store.dart';
...
class MapSampleState extends State<MapSample> {
  ...
  void handleFetchStores() async {
    ...
    for (var store in stores) {
      final bitmapIcon = await BitmapDescriptor.fromAssetImage(ImageConfiguration(size: Size(48,48)), 'assets/shop1.png');
      markers.add(Marker(
  ...
  Future<List<Store>> fetchStores() async {
    var response = await http.get(Uri.parse('http://192.168.1.3:8000/api/stores'));
